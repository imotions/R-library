...
your research purposes. It is recommended to read this article first to gain an overview of how R Notebook is composed 
...
The full Skin Temperature R Notebook script is uploaded here.
The iMotions study link is at the bottom of  this article (For signed in users only).
...
example, it’s “Biopac”) and “instance” (a value given by iMotions based on what sensor you connected. 
In this example, it’s “SKT100C”):
