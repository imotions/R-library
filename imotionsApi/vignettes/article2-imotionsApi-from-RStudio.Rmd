...
# Tutorial 2: How to Access iMotions Data from RStudio
...
your research purposes. It is recommended to read [this article](https://github.com/imotions/R-library/tree/add_tutorials/documentation/article1-example-notebook-explained.html) first to gain an overview of how R Notebook is composed 
...
[here](https://raw.githubusercontent.com/imotions/R-library/add_tutorials/documentation/imotionsApi_2.1.2.pdf) for an overview of available functions and detailed descriptions or type ?imotionsApi in the RStudio console. 
